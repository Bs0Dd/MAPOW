...
Mobile Action USB cables based on the Prolific **PL2303** USB-TTL chip (**MA-xxxxP**) have an **additional chip** to enable and disable charging voltage.  
This chip is attached to the **RX** and **TX** lines, but accessible only when communicating at **9600 bit/s** with **disabled DTR** line.
